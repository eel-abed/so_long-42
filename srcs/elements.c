...
/*   Updated: 2024/07/02 15:26:37 by eel-abed         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_elements(mlx_t *mlx, GameAssets* game_assets)
{
	...
	game_assets->obstacle->instances = malloc(999 * sizeof(*game_assets->obstacle->instances));
	...
	game_assets->collectible->instances = malloc(999 * sizeof(*game_assets->collectible->instances));
